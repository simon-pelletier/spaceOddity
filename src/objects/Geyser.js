...
export default class Geyser extends Phaser.GameObjects.GameObject {
    ...
    constructor(config) {
        ...
        /* -------------------------------- Controls -------------------------------- */
        this.keyPumpFuel = config.scene.input.keyboard.addKey(
        ...
        var geyserBodyPartA = Bodies.circle(0, -200, 80, {
            label: 'geyserBodyPartA',
            isSensor: true
        });
        var geyserBodyPartB = Bodies.circle(0, 350, 80, {
            label: 'geyserBody',
            isSensor: true,
            data: {
                id: this.id
        ...
        this.geyser = scene.matter.add.sprite(
        ...
        this.geyser.setPosition(
            this.points[this.indice].x,
            this.points[this.indice].y
        );
        this.geyser.rotation =
        ...
        this.geyserText = config.scene.add
            .text(0, 0, '', styleText)
            .setPadding(10, 10);
        this.geyserText.setDepth(0);
        this.geyserText.setPosition(
            this.pointsInfo[this.indice].x,
            this.pointsInfo[this.indice].y
        );
        this.geyserText.rotation =
            1.56 + (this.indice + this.margin) / this.points.length;
        this.geyserText.setText(this.quantity);
